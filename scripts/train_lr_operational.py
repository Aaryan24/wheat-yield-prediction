...
def _run_lr_for_opdate(
    ...
    # Train Model
    _log("Phase 3: Training Linear Regression on PCA-reduced features...")
    ...
    _log("Phase 3: Analyzing Linear Regression performance...")
    bucket_counts = _analyze_errors(test_y, test_pred, "Test Set (LR)")
    ...
    if pred_dir is not None:
        ...
        pred_path = pred_dir / f"predictions_lr_opdate_{pred_key}.csv"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Train Linear Regression on Informer Embeddings."
    )
    ...
    parser.add_argument("--out-dir", type=str, default="experiments/linear_regression")
