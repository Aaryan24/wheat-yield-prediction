...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run B4_e6e7_5d_h25_s42 on Apple MPS (single fast-path run)."
    )
    parser.add_argument("--out-dir", type=str, default="codex_v2/experiments/B4_e6e7_5d_h25_s42")
    ...
    parser.add_argument("--config-train", type=str, default="codex_v2/configs/train_shared_mps_120fixed.yaml")
...
def main() -> None:
    ...
    if not args.dry_run and not _mps_is_available():
        raise RuntimeError(
            ...
            "Use CPU config or install Apple Silicon PyTorch with MPS."
        )
    ...
    print("Run:", "B4_e6e7_5d_h25_s42", flush=True)
